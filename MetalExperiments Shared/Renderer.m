...
- (void)_updateGameState
{
    ...
    matrix_float4x4 modelMatrix = wl_rotation(_rotation, rotationAxis);
    matrix_float4x4 viewMatrix = wl_translation(0.0, 0.0, -8.0);
...
- (void)mtkView:(nonnull MTKView *)view drawableSizeWillChange:(CGSize)size
{
    ...
    _projectionMatrix = wl_perspective(65.0f * (M_PI / 180.0f), aspect, 0.1f, 100.0f);
}
